...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    private val notificationManager by lazy { getSystemService(Context.NOTIFICATION_SERVICE)
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        val notificationBuilder = when {
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.O -> NotificationCompat
                .Builder(this, appName)
        ...
        notificationManager.notify(Calendar.getInstance().timeInMillis.toInt(),
